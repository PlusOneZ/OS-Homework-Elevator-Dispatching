      ...
      <div class="relative inline-flex shadow-lg sm:rounded-3xl rounded-xl bg-gradient-to-bl from-blue-300 to-blue-500 p-2">
        <div>
          <div class="p-1 sm:p-2" v-if="canUp">
            ...
            >
              <svg class="h-8 sm:h-10 sm:w-14 p-1" viewBox="0 0 1317 1024" xmlns="http://www.w3.org/2000/svg" width="50" height="50"><path
        ...
        <div class="text-5xl sm:py-10 sm:px-2 font-mono font-extrabold px-4 py-6">
          {{ displayFloor() }}
        </div>
      </div>
    </div>
